...
from meteor.logging import logging
from meteor.config import SQLALCHEMY_DATABASE_URI
from meteor.database.core import Base
import meteor.auth.models
import meteor.appsettings.models
import meteor.observation.models 
...
def run_migrations_online():
    ...
    log.info("Migrating meteor core schema...")
