...
class IPlugin(local):
    ...
    def get_resource_links(self) -> List[Any]:
        ...
        >>>     return [
        >>>         ('Documentation', 'https://meteor.readthedocs.io'),
        >>>         ('Bug Tracker', 'https://github.com/MeteorFlow/meteor/issues'),
        >>>         ('Source', 'https://github.com/MeteorFlow/meteor'),
        >>>     ]
        """
